...
public class SslPinningWebViewClient extends WebViewClient {
    ...
    public SslPinningWebViewClient(LoadedListener listener)throws IOException {
        ...
        prepareSslPinning(MyApplication.getApplication().getResources().openRawResource(R.raw.ca2));
    }
    ...
    private WebResourceResponse processRequest(Uri uri) {
        ...
        try {
            ...
            Log.d("SSL_PINNING_WEBVIEWS1", e.getLocalizedMessage());
        } catch (Exception e) {
            Log.d("SSL_PINNING_WEBVIEWS2", e.getLocalizedMessage());
        }
    ...
    private void prepareSslPinning(InputStream... certificates)throws IOException {
        ...
        try {
            ...
            InputStream inputStream = MyApplication.getApplication().getResources().openRawResource(R.raw.ca3);

            TrustManager[] trustManagers = prepareTrustManager(certificates);
            KeyManager[] keyManagers = prepareKeyManager(inputStream, "123456");
